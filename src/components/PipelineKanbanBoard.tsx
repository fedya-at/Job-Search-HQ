...
const PIPELINE_COLUMNS: KanbanColumnDef[] = [
  {
    ...
    bgBadge: 'bg-amber-100 text-amber-900 border border-amber-200',
    lightHeader: 'bg-gradient-to-r from-amber-50 to-orange-50',
  ...
  },
  {
    ...
    bgBadge: 'bg-blue-100 text-blue-900 border border-blue-200',
    lightHeader: 'bg-gradient-to-r from-blue-50 to-sky-50',
  ...
  },
  {
    ...
    color: '#0284c7',
    dotColor: 'bg-sky-500',
    bgBadge: 'bg-sky-100 text-sky-900 border border-sky-200',
    lightHeader: 'bg-gradient-to-r from-sky-50 to-cyan-50',
  ...
  },
  {
    ...
    bgBadge: 'bg-purple-100 text-purple-900 border border-purple-200',
    lightHeader: 'bg-gradient-to-r from-purple-50 to-indigo-50',
  ...
  },
  {
    ...
    bgBadge: 'bg-emerald-100 text-emerald-900 border border-emerald-200',
    lightHeader: 'bg-gradient-to-r from-emerald-50 to-teal-50',
  ...
  },
  {
    ...
    bgBadge: 'bg-teal-100 text-teal-900 border border-teal-200',
    lightHeader: 'bg-gradient-to-r from-teal-50 to-emerald-50',
  ...
  },
  {
    ...
    bgBadge: 'bg-rose-100 text-rose-900 border border-rose-200',
    lightHeader: 'bg-gradient-to-r from-rose-50 to-slate-50',
